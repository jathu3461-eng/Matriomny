/**
 * Complete country + dial-code list for the React Native mobile app.
 * Mirrors web/src/lib/phoneCountries.js exactly (TypeScript version).
 *
 * Priority countries (Sri Lankan diaspora) appear first.
 */

export interface Country {
  code: string;    // ISO 3166-1 alpha-2
  name: string;    // English display name
  dialCode: string; // E.164 prefix, e.g. "+94"
  flag: string;    // emoji flag
}

export const PRIORITY_CODES: string[] = ['LK', 'IN', 'AE', 'AU', 'CA', 'GB', 'US'];
...
/** Sri Lanka — the default country for Mukurtham Matrimony. */
export const DEFAULT_COUNTRY: Country = COUNTRIES[0];

/** Find a country by ISO alpha-2 code. Returns DEFAULT_COUNTRY if not found. */
 ...
 * Matches longest prefix first (+971 before +97 before +9).
 */
